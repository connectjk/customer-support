# Deployment Guide – customer-support
...
docker build -t $AZURE_ACR_NAME.azurecr.io/customer-support:latest .
docker push $AZURE_ACR_NAME.azurecr.io/customer-support:latest
```
...
az containerapp create \\
  ...
  --image $AZURE_ACR_NAME.azurecr.io/customer-support:latest \\
  --target-port 8080 \\
  --ingress external \\
  --min-replicas 1 \\
  --max-replicas 5 \\
